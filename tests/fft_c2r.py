...
if __name__ == "__main__":
    ...
    test_1d_c2r(N=5001)
    print("=== 1D C2R float                ===")
    test_1d_c2r(N=5001, dtype=np.float32)
    print("=== 2D C2R double               ===")
    test_2d_c2r(N=(128, 256))
    print("=== 2D C2R float                ===")
    test_2d_c2r(N=(128, 256), dtype=np.float32)
    print("=== 3D C2R double               ===")
    test_3d_c2r(N=(64, 20, 50))
    print("=== 3D C2R float                ===")
    test_3d_c2r(N=(64, 20, 50), dtype=np.float32)
