...
#ifndef __NUMPY_NOT_EQUAL_REDUCE_H__
#define __NUMPY_NOT_EQUAL_REDUCE_H__

#include "numpy.h"

namespace legate {
namespace numpy {
// For doing a not equal reduction test
template<typename T>
class NotEqualReducTask : public NumPyTask<NotEqualReducTask<T>> {
public:
...
#endif    // __NUMPY_NOT_EQUAL_REDUCE_H__
