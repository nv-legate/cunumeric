...
public:
  ...
  static void record_variant(Legion::TaskID tid, const char* task_name, const Legion::CodeDescriptor& desc,
                             Legion::ExecutionConstraintSet&  execution_constraints,
                             Legion::TaskLayoutConstraintSet& layout_constraints, LegateVariant var, Legion::Processor::Kind kind,
                             bool leaf, bool inner, bool idempotent, bool ret_type);

public:
  struct PendingTaskVariant : public Legion::TaskVariantRegistrar {
  public:
    PendingTaskVariant(void) : Legion::TaskVariantRegistrar(), task_name(NULL), var(LEGATE_NO_VARIANT) {}
    PendingTaskVariant(Legion::TaskID tid, bool global, const char* var_name, const char* t_name,
                       const Legion::CodeDescriptor& desc, LegateVariant v, bool ret)
        : Legion::TaskVariantRegistrar(tid, global, var_name), task_name(t_name), descriptor(desc), var(v), ret_type(ret) {}
...
public:
  ...
  static void record_variant(Legion::TaskID tid, const Legion::CodeDescriptor& desc,
    ...
    LegateNumPy::record_variant(tid, NumPyTask<T>::task_name(), desc, execution_constraints, layout_constraints, var, kind, leaf,
                                inner, idempotent, ret_type);
  }
};
...
#define INSTANTIATE_TASK_VARIANT(type, variant)                                                              \
  template void type<float>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);    \
  template void type<double>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);   \
  template void type<int16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template void type<int32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template void type<int64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template void type<uint16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template void type<uint32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template void type<uint64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template void type<bool>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);     \
  template void type<__half>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);   \
  template void type<complex<float>>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);
     // template void type<complex<double>>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);
...
#define INSTANTIATE_DEFERRED_REDUCTION_TASK_VARIANT(type, redop, variant)                                                            \
  template DeferredReduction<redop<float>>    type<float>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,         \
                                                                Runtime*);                                                        \
  template DeferredReduction<redop<double>>   type<double>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,        \
                                                                  Runtime*);                                                       \
  template DeferredReduction<redop<int16_t>>  type<int16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,       \
                                                                    Runtime*);                                                      \
  template DeferredReduction<redop<int32_t>>  type<int32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,       \
                                                                    Runtime*);                                                      \
  template DeferredReduction<redop<int64_t>>  type<int64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,       \
                                                                    Runtime*);                                                      \
  template DeferredReduction<redop<uint16_t>> type<uint16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,      \
                                                                      Runtime*);                                                     \
  template DeferredReduction<redop<uint32_t>> type<uint32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,      \
                                                                      Runtime*);                                                     \
  template DeferredReduction<redop<uint64_t>> type<uint64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,      \
                                                                      Runtime*);                                                     \
  template DeferredReduction<redop<bool>>   type<bool>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template DeferredReduction<redop<__half>> type<__half>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,          \
                                                                  Runtime*);                                                         \
  template DeferredReduction<redop<complex<float>>> type<complex<float>>::variant(const Task*, const std::vector<PhysicalRegion>&,   \
                                                                                  Context, Runtime*);
     // template DeferredReduction<redop<complex<double>>   type<complex<double>>::variant(const Task*, const
     // std::vector<PhysicalRegion>&, Context, Runtime*);

#define INSTANTIATE_DEFERRED_REDUCTION_ARG_RETURN_TASK_VARIANT(type, redop, variant)                                            \
  template DeferredReduction<redop<uint64_t>> type<float>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,    \
                                                                   Runtime*);                                                   \
  template DeferredReduction<redop<uint64_t>> type<double>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,   \
                                                                    Runtime*);                                                  \
  template DeferredReduction<redop<uint64_t>> type<int16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,  \
                                                                     Runtime*);                                                 \
  template DeferredReduction<redop<uint64_t>> type<int32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,  \
                                                                     Runtime*);                                                 \
  template DeferredReduction<redop<uint64_t>> type<int64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,  \
                                                                     Runtime*);                                                 \
  template DeferredReduction<redop<uint64_t>> type<uint16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, \
                                                                      Runtime*);                                                \
  template DeferredReduction<redop<uint64_t>> type<uint32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, \
                                                                      Runtime*);                                                \
  template DeferredReduction<redop<uint64_t>> type<uint64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, \
                                                                      Runtime*);                                                \
  template DeferredReduction<redop<uint64_t>> type<bool>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,     \
                                                                  Runtime*);                                                    \
  template DeferredReduction<redop<uint64_t>> type<__half>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,   \
                                                                    Runtime*);                                                  \
  template DeferredReduction<redop<uint64_t>> type<complex<float>>::variant(const Task*, const std::vector<PhysicalRegion>&,    \
                                                                            Context, Runtime*);
// template DeferredReduction<redop<uint64_t>> type<complex<double>>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,   \
  //                                                                   Runtime*);                                                  \

#define INSTANTIATE_DEFERRED_VALUE_TASK_VARIANT(type, return_type, variant)                                                        \
  template DeferredValue<return_type> type<float>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);    \
  template DeferredValue<return_type> type<double>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);   \
  template DeferredValue<return_type> type<int16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template DeferredValue<return_type> type<int32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template DeferredValue<return_type> type<int64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);  \
  template DeferredValue<return_type> type<uint16_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template DeferredValue<return_type> type<uint32_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template DeferredValue<return_type> type<uint64_t>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*); \
  template DeferredValue<return_type> type<bool>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);     \
  template DeferredValue<return_type> type<__half>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);   \
  template DeferredValue<return_type> type<complex<float>>::variant(const Task*, const std::vector<PhysicalRegion>&, Context,      \
                                                                    Runtime*);

// template DeferredValue<return_type> type<complex<double>>::variant(const Task*, const std::vector<PhysicalRegion>&, Context, Runtime*);   \
...
#define REGISTER_ALL_TASKS_WITH_FLOAT_RETURN(type)                                                        \
  {                                                                                                       \
    ...
    type<complex<float>>::register_variants_with_return<complex<float>, DeferredValue<complex<float>>>(); \
  }
     // type<complex<double>>::register_variants_with_return<complex<double>, DeferredValue<complex<double>>>();   \
...
#define REGISTER_ALL_TASKS_WITH_REDUCTION_RETURN(type, redop)                                                        \
  {                                                                                                                  \
    ...
    type<complex<float>>::register_variants_with_return<complex<float>, DeferredReduction<redop<complex<float>>>>(); \
  }
     // type<complex<double>>::register_variants_with_return<complex<double>, DeferredReduction<redop<complex<double>>>>();       \
...
#define REGISTER_ALL_TASKS_WITH_WRAP_REDUCTION_RETURN(type, wrap, redop)                                                   \
  {                                                                                                                        \
    ...
    type<int16_t>::register_variants_with_return<wrap<int16_t>, DeferredReduction<redop<int16_t>>>();                      \
    type<int32_t>::register_variants_with_return<wrap<int32_t>, DeferredReduction<redop<int32_t>>>();                      \
    type<int64_t>::register_variants_with_return<wrap<int64_t>, DeferredReduction<redop<int64_t>>>();                      \
    type<uint16_t>::register_variants_with_return<wrap<uint16_t>, DeferredReduction<redop<uint16_t>>>();                   \
    type<uint32_t>::register_variants_with_return<wrap<uint32_t>, DeferredReduction<redop<uint32_t>>>();                   \
    type<uint64_t>::register_variants_with_return<wrap<uint64_t>, DeferredReduction<redop<uint64_t>>>();                   \
    ...
    type<complex<float>>::register_variants_with_return<wrap<complex<float>>, DeferredReduction<redop<complex<float>>>>(); \
  }
     // type<complex<double>>::register_variants_with_return<wrap<complex<double>>, DeferredReduction<redop<complex<double>>>>(); \
...
#define REGISTER_ALL_TASKS_WITH_REDUCTION_ARG_RETURN(type, redop)                                        \
  {                                                                                                      \
    ...
    type<complex<float>>::register_variants_with_return<uint64_t, DeferredReduction<redop<uint64_t>>>(); \
  }
     // type<complex<double>>::register_variants_with_return<uint64_t, DeferredReduction<redop<uint64_t>>>();   \
...
#define REGISTER_ALL_REDUCTIONS(type, offset)                                                      \
  {                                                                                                \
    ...
    Runtime::register_reduction_op<type<complex<float>>>(offset + type<complex<float>>::REDOP_ID); \
     ...
     // Runtime::register_reduction_op<type<complex<double>>>(offset + type<complex<double>>::REDOP_ID);     \
