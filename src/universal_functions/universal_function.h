...
struct BinaryUniversalFunction {
  ...
  struct InplaceBroadcastTask : public InplaceBroadcastBinaryOperationTask<InplaceBroadcastTask, BinaryOperation> {};
  ...
  void instantiate_task_gpu_variants() {
    ...
    printf("%p %p %p %p", NormalTask::gpu_variant, InplaceNormalTask::gpu_variant, BroadcastTask::gpu_variant,
           InplaceBroadcastTask::gpu_variant);
  }
#endif
};

// XXX investigate whether it would be convenient to merge this class with BinaryUniversalFunction somehow
template<class BinaryOperation>
struct NoncommutativeBinaryUniversalFunction {
  ...
  struct InplaceNormalTask : public InplaceBinaryOperationTask<InplaceNormalTask, BinaryOperation> {};
  struct ScalarTask : public ScalarBinaryOperationTask<ScalarTask, BinaryOperation> {};
  struct BroadcastTask : public NoncommutativeBroadcastBinaryOperationTask<BroadcastTask, BinaryOperation> {};
  struct InplaceBroadcastTask : public InplaceBroadcastBinaryOperationTask<InplaceBroadcastTask, BinaryOperation> {};
