...
template <typename T>
/*static*/ bool NotEqualReducTask<T>::cpu_variant(const Task* task,
...
template <typename T>
/*static*/ bool NotEqualReducTask<T>::omp_variant(const Task* task,
                                                  const std::vector<PhysicalRegion>& regions,
                                                  Context ctx,
                                                  Runtime* runtime)
{
...
INSTANTIATE_ALL_TASKS(NotEqualReducTask,
                      static_cast<int>(NumPyOpCode::NUMPY_NOT_EQUAL) * NUMPY_TYPE_OFFSET +
