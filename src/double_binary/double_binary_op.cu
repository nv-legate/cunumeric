...
#include "double_binary/binary_op.h"
...
struct DoubleBinaryOpImplBody<VariantKind::GPU, OP_CODE, CODE, DIM> {
...
/*static*/ void DoubleBinaryOpTask::gpu_variant(TaskContext& context)
{
  double_binary_op_template<VariantKind::GPU>(context);
}
