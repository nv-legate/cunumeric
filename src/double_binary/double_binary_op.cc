...
#include "double_binary/double_binary_op_template.inl"
...
struct DoubleBinaryOpImplBody<VariantKind::CPU, OP_CODE, CODE, DIM> {
...
/*static*/ void DoubleBinaryOpTask::cpu_variant(TaskContext& context)
{
  double_binary_op_template<VariantKind::CPU>(context);
}

namespace  // unnamed
{
static void __attribute__((constructor)) register_tasks(void) { DoubleBinaryOpTask::register_variants(); }
}  // namespace
