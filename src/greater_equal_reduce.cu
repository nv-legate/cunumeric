...
__global__ void __launch_bounds__(THREADS_PER_BLOCK, MIN_CTAS_PER_SM)
  legate_geq_reduce_1d(DeferredValue<bool> result,
...
template <typename T>
__global__ void __launch_bounds__(THREADS_PER_BLOCK, MIN_CTAS_PER_SM)
  legate_geq_reduce_2d(DeferredValue<bool> result,
...
template <typename T>
__global__ void __launch_bounds__(THREADS_PER_BLOCK, MIN_CTAS_PER_SM)
  legate_geq_reduce_3d(DeferredValue<bool> result,
...
template <typename T>
/*static*/ DeferredValue<bool> GreaterEqualReducTask<T>::gpu_variant(
