...
#ifndef __NUMPY_LESS_EQUAL_REDUCE_H__
#define __NUMPY_LESS_EQUAL_REDUCE_H__
...
template <typename T>
class LessEqualReducTask : public NumPyTask<LessEqualReducTask<T>> {
 public:
...
#endif  // __NUMPY_LESS_EQUAL_REDUCE_H__
