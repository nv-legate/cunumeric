...
template <typename T>
/*static*/ bool GreaterEqualReducTask<T>::cpu_variant(const Task* task,
...
template <typename T>
/*static*/ bool GreaterEqualReducTask<T>::omp_variant(const Task* task,
                                                      const std::vector<PhysicalRegion>& regions,
                                                      Context ctx,
                                                      Runtime* runtime)
{
...
INSTANTIATE_ALL_TASKS(GreaterEqualReducTask,
                      static_cast<int>(NumPyOpCode::NUMPY_GREATER_EQUAL) * NUMPY_TYPE_OFFSET +
