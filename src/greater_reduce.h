...
#ifndef __NUMPY_GREATER_REDUCE_H__
#define __NUMPY_GREATER_REDUCE_H__
...
template <typename T>
class GreaterReducTask : public NumPyTask<GreaterReducTask<T>> {
 public:
...
#endif  // __NUMPY_GREATER_REDUCE_H__
