...
template <>
__CUDA_HD__ inline complex<__half> convert<complex<__half>, complex<float>>(
  const complex<float>& arg)
{
  return complex<__half>(static_cast<__half>(arg.real()), static_cast<__half>(arg.imag()));
}

template <>
__CUDA_HD__ inline complex<__half> convert<complex<__half>, complex<double>>(
  const complex<double>& arg)
{
  return complex<__half>(static_cast<__half>(arg.real()), static_cast<__half>(arg.imag()));
}

template <>
__CUDA_HD__ inline complex<float> convert<complex<float>, complex<__half>>(
  const complex<__half>& arg)
{
  return complex<float>(arg.real(), arg.imag());
}

template <>
__CUDA_HD__ inline complex<float> convert<complex<float>, complex<double>>(
  const complex<double>& arg)
{
  return complex<float>(arg.real(), arg.imag());
}
...
template <>
__CUDA_HD__ inline complex<double> convert<complex<double>, complex<__half>>(
  const complex<__half>& arg)
{
...
template <>
__CUDA_HD__ inline complex<double> convert<complex<double>, complex<float>>(
  const complex<float>& arg)
{
  return complex<double>(arg.real(), arg.imag());
}
