...
template <>
struct ContractImplBody<VariantKind::OMP, Type::FLOAT32> {
...
template <>
struct ContractImplBody<VariantKind::OMP, Type::FLOAT64> {
...
template <>
struct ContractImplBody<VariantKind::OMP, Type::FLOAT16> {
                  ...
                  bool lhs_overwritable)
  {
    ...
    ContractImplBody<VariantKind::OMP, Type::FLOAT32>{}(lhs_copy_data,
                                                        lhs_ndim,
                                                        lhs_shape,
...
template <>
struct ContractImplBody<VariantKind::OMP, Type::COMPLEX64> {
...
template <>
struct ContractImplBody<VariantKind::OMP, Type::COMPLEX128> {
