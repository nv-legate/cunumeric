...
template <>
struct ContractImplBody<VariantKind::CPU, Type::FLOAT32> {
...
template <>
struct ContractImplBody<VariantKind::CPU, Type::FLOAT64> {
...
template <>
struct ContractImplBody<VariantKind::CPU, Type::FLOAT16> {
                  ...
                  bool lhs_overwritable)
  {
    ...
    ContractImplBody<VariantKind::CPU, Type::FLOAT32>{}(lhs_copy_data,
                                                        lhs_ndim,
                                                        lhs_shape,
...
template <>
struct ContractImplBody<VariantKind::CPU, Type::COMPLEX64> {
...
template <>
struct ContractImplBody<VariantKind::CPU, Type::COMPLEX128> {
