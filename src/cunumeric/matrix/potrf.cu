...
template <>
struct PotrfImplBody<VariantKind::GPU, Type::FLOAT32> {
...
template <>
struct PotrfImplBody<VariantKind::GPU, Type::FLOAT64> {
...
template <>
struct PotrfImplBody<VariantKind::GPU, Type::COMPLEX64> {
...
template <>
struct PotrfImplBody<VariantKind::GPU, Type::COMPLEX128> {
