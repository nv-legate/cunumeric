...
struct MatVecMulImplBody<KIND, Type::FLOAT32> {
...
template <VariantKind KIND>
struct MatVecMulImplBody<KIND, Type::FLOAT64> {
  void operator()(size_t m,
                  size_t n,
                  double* lhs,
                  const double* mat,
...
template <VariantKind KIND>
struct MatVecMulImplBody<KIND, Type::FLOAT16> {
  void operator()(size_t m,
                  size_t n,
                  float* lhs,
                  const __half* mat,
                  ...
                  bool lhs_overwritable)
  {
    ...
    MatVecMulImplBody<KIND, Type::FLOAT32>{}(
      m, n, lhs, mat_copy, vec_copy, n, transpose_mat, lhs_overwritable);
  }
};

template <VariantKind KIND>
struct MatVecMulImplBody<KIND, Type::COMPLEX64> {
  void operator()(size_t m,
                  size_t n,
                  complex<float>* lhs_,
...
template <VariantKind KIND>
struct MatVecMulImplBody<KIND, Type::COMPLEX128> {
  void operator()(size_t m,
                  size_t n,
                  complex<double>* lhs_,
