...
struct SolveImplBody<KIND, Type::FLOAT32> {
...
template <VariantKind KIND>
struct SolveImplBody<KIND, Type::FLOAT64> {
...
template <VariantKind KIND>
struct SolveImplBody<KIND, Type::COMPLEX64> {
...
template <VariantKind KIND>
struct SolveImplBody<KIND, Type::COMPLEX128> {
