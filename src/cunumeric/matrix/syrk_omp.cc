...
template <>
struct SyrkImplBody<VariantKind::CPU, Type::FLOAT32> {
...
template <>
struct SyrkImplBody<VariantKind::CPU, Type::FLOAT64> {
...
template <>
struct SyrkImplBody<VariantKind::CPU, Type::COMPLEX64> {
...
template <>
struct SyrkImplBody<VariantKind::CPU, Type::COMPLEX128> {
