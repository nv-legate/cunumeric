...
template <>
struct support_solve<Type::FLOAT64> : std::true_type {};
template <>
struct support_solve<Type::FLOAT32> : std::true_type {};
template <>
struct support_solve<Type::COMPLEX64> : std::true_type {};
template <>
struct support_solve<Type::COMPLEX128> : std::true_type {};

template <VariantKind KIND>
struct SolveImpl {
  template <Type CODE, std::enable_if_t<support_solve<CODE>::value>* = nullptr>
