...
template <>
struct PotrfImplBody<VariantKind::CPU, Type::FLOAT32> {
...
template <>
struct PotrfImplBody<VariantKind::CPU, Type::FLOAT64> {
...
template <>
struct PotrfImplBody<VariantKind::CPU, Type::COMPLEX64> {
...
template <>
struct PotrfImplBody<VariantKind::CPU, Type::COMPLEX128> {
