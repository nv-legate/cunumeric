...
template <>
struct SyrkImplBody<VariantKind::GPU, Type::FLOAT32> {
...
template <>
struct SyrkImplBody<VariantKind::GPU, Type::FLOAT64> {
...
template <>
struct SyrkImplBody<VariantKind::GPU, Type::COMPLEX64> {
...
template <>
struct SyrkImplBody<VariantKind::GPU, Type::COMPLEX128> {
