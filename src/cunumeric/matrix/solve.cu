...
template <>
struct SolveImplBody<VariantKind::GPU, Type::FLOAT32> {
...
template <>
struct SolveImplBody<VariantKind::GPU, Type::FLOAT64> {
...
template <>
struct SolveImplBody<VariantKind::GPU, Type::COMPLEX64> {
...
template <>
struct SolveImplBody<VariantKind::GPU, Type::COMPLEX128> {
