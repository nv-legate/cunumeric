...
template <ConvertCode NAN_OP, legate::Type DST_TYPE, legate::Type SRC_TYPE>
struct ConvertOp {};

template <legate::Type DST_TYPE, legate::Type SRC_TYPE>
struct ConvertOp<ConvertCode::NOOP, DST_TYPE, SRC_TYPE> {
  ...
  constexpr DST operator()(const _SRC& src) const
  {
    if constexpr (DST_TYPE == legate::Type::BOOL)
...
template <legate::Type SRC_TYPE>
struct ConvertOp<ConvertCode::NOOP, legate::Type::FLOAT16, SRC_TYPE> {
  using SRC = legate::legate_type_of<SRC_TYPE>;
...
template <legate::Type DST_TYPE>
struct ConvertOp<ConvertCode::NOOP, DST_TYPE, legate::Type::FLOAT16> {
  using DST = legate::legate_type_of<DST_TYPE>;
...
template <legate::Type SRC_TYPE>
struct ConvertOp<ConvertCode::PROD, legate::Type::FLOAT16, SRC_TYPE> {
  using SRC = legate::legate_type_of<SRC_TYPE>;
...
template <legate::Type DST_TYPE>
struct ConvertOp<ConvertCode::PROD, DST_TYPE, legate::Type::FLOAT16> {
  using DST = legate::legate_type_of<DST_TYPE>;
...
template <legate::Type SRC_TYPE>
struct ConvertOp<ConvertCode::SUM, legate::Type::FLOAT16, SRC_TYPE> {
  using SRC = legate::legate_type_of<SRC_TYPE>;
...
template <legate::Type DST_TYPE>
struct ConvertOp<ConvertCode::SUM, DST_TYPE, legate::Type::FLOAT16> {
  using DST = legate::legate_type_of<DST_TYPE>;
