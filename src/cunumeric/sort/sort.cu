...
template <>
struct support_cub<Type::COMPLEX64> : std::false_type {};
template <>
struct support_cub<Type::COMPLEX128> : std::false_type {};

template <Type CODE, std::enable_if_t<support_cub<CODE>::value>* = nullptr>
