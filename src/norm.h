...
#ifndef __NUMPY_NORM_H__
#define __NUMPY_NORM_H__
...
template <typename T>
class NormTask : public NumPyTask<NormTask<T>> {
 public:
...
template <typename T>
class NormReducTask : public NumPyTask<NormReducTask<T>> {
 public:
  static const int TASK_ID;
