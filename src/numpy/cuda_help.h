...
load_cached<uint16_t>(const uint16_t *ptr)
{
  uint16_t value;
...
load_cached<uint32_t>(const uint32_t *ptr)
{
  uint32_t value;
...
load_cached<uint64_t>(const uint64_t *ptr)
{
  uint64_t value;
...
load_cached<int16_t>(const int16_t *ptr)
{
  int16_t value;
...
load_cached<int32_t>(const int32_t *ptr)
{
  int32_t value;
...
load_cached<int64_t>(const int64_t *ptr)
{
  int64_t value;
...
load_cached<float>(const float *ptr)
{
  float value;
...
load_cached<double>(const double *ptr)
{
  double value;
...
template<>
__device__ __forceinline__ uint16_t
load_l2<uint16_t>(const uint16_t *ptr)
{
  uint16_t value;
...
template<>
__device__ __forceinline__ uint32_t
load_l2<uint32_t>(const uint32_t *ptr)
{
  uint32_t value;
...
template<>
__device__ __forceinline__ uint64_t
load_l2<uint64_t>(const uint64_t *ptr)
{
  uint64_t value;
...
template<>
__device__ __forceinline__ int16_t
load_l2<int16_t>(const int16_t *ptr)
{
  int16_t value;
...
template<>
__device__ __forceinline__ int32_t
load_l2<int32_t>(const int32_t *ptr)
{
  int32_t value;
...
template<>
__device__ __forceinline__ int64_t
load_l2<int64_t>(const int64_t *ptr)
{
  int64_t value;
...
template<>
__device__ __forceinline__ double
load_l2<double>(const double *ptr)
{
  double value;
...
template<>
__device__ __forceinline__ uint16_t
load_streaming<uint16_t>(const uint16_t *ptr)
{
  uint16_t value;
...
template<>
__device__ __forceinline__ uint32_t
load_streaming<uint32_t>(const uint32_t *ptr)
{
  uint32_t value;
...
template<>
__device__ __forceinline__ uint64_t
load_streaming<uint64_t>(const uint64_t *ptr)
{
  uint64_t value;
...
template<>
__device__ __forceinline__ int16_t
load_streaming<int16_t>(const int16_t *ptr)
{
  int16_t value;
...
template<>
__device__ __forceinline__ int32_t
load_streaming<int32_t>(const int32_t *ptr)
{
  int32_t value;
...
template<>
__device__ __forceinline__ int64_t
load_streaming<int64_t>(const int64_t *ptr)
{
  int64_t value;
...
template<>
__device__ __forceinline__ float
load_streaming<float>(const float *ptr)
{
  float value;
...
template<>
__device__ __forceinline__ double
load_streaming<double>(const double *ptr)
{
  double value;
...
template<>
__device__ __forceinline__ void
store_streaming<uint16_t>(uint16_t *ptr, uint16_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<uint32_t>(uint32_t *ptr, uint32_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<uint64_t>(uint64_t *ptr, uint64_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<int16_t>(int16_t *ptr, int16_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<int32_t>(int32_t *ptr, int32_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<int64_t>(int64_t *ptr, int64_t value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<float>(float *ptr, float value)
{
...
template<>
__device__ __forceinline__ void
store_streaming<double>(double *ptr, double value)
{
